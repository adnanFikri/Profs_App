...
<div class="bg-gray-100 flex-1 p-6  md:mt-16">
    ...
    <form class="bg-white px-20" method="POST" action="{{ route('inscription.store') }}" enctype="multipart/form-data">
        @csrf
...
{{-- || =-=-=-=-=- Sector =-=-=-=-=-=- || --}}
        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
            ...
            <select id="underline_select" required  name="sector_lp" class="block  pl-1  px-0 w-full te text-gray-500 bg-transparent border-0 border-gray-200 appearance-none dark:text-dark-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
...
{{-- || =-=-=-=-=- Profile =-=-=-=-=-=-|| --}}
        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 mt-4">
            ...
            <input placeholder="Profile" required  name="profile" class="block w-full ml-2 text-sm text-gray-900  border-none rounded-l cursor-pointer bg- dark:text-gray-300 focus:outline-none dark:bg-gray-700 dark:border-gray-600     dark:placeholder-gray-400" id="profile" type="file">
        </div>
{{-- || =-=-=-=-=- Sector Bac =-=-=-=-=-=- || --}}
        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
            ...
            <select id="underline_select" required name="sector_bac" class="block  pl-1  px-0 w-full te text-gray-500 bg-transparent border-0 border-gray-200 appearance-none dark:text-dark-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
...
{{-- || =-=-=-=-=- University Name  Bac+2 =-=-=-=-=-=- || --}}
        <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
            ...
            <select id="underline_select" required  name="university_name" class="block  pl-1  px-0 w-full te text-gray-500 bg-transparent border-0 border-gray-200 appearance-none dark:text-dark-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
